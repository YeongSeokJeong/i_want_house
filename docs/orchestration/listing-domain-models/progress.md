...
|------------|--------------|--------|--------------|--------|---------|
| F-001 | Domain conversion layer | DONE | 1 | - | 2026-06-20 |
| F-002 | Analyzer and validator adoption | TODO | - | - | 2026-06-20 |
...
| 1 | F-001 | Domain conversion layer | Done | - | 2026-06-20 |
...
- Next Feature: Analyzer and validator adoption
- Description: Use the new model conversion layer at analyzer and validator boundaries while keeping public dict-compatible behavior.
