...
| 3 | F-005 | Operator configuration | Switch active watchlist to sale listings for 백련산힐스테이트3차 and 불광 미성아파트 | User supplied Naver complex numbers, monitored areas, and sale target prices | Fixture and workflow configuration now match the two active sale targets | 2026-06-15 |
